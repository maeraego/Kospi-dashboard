...
def analyze(idx):
    ...
    _VOL_AMP = {'실현변동성(20일)': 1.0, 'VIX 급등(YoY)': 1.0}
    _VOL_FLOOR = 0.03
...
comp = {
    ...
    '기준금리': df['기준금리'], '환율': df['원달러'], '실현변동성(20일)': df['KOSPI_변동성'],
...
_SIG2COL2 = {'PBR': 'PBR', 'PER': 'PER', 'ROE': 'ROE', '실현변동성(20일)': '실현변동성(20일)',
...
SIG2COL = {'PBR': 'PBR', 'PER': 'PER', 'ROE': 'ROE', '실현변동성(20일)': '실현변동성(20일)',
           '선행 PBR': '선행 PBR',
           '환율(원/달러)': '환율', '경기선행지수': '경기선행지수', '신용스프레드': '신용스프레드',
           '일드커브': '일드커브', '국고채10년': '국고채10년',
           'WTI 유가': 'WTI 유가', '미국10년 YoY': '미국10년 YoY',
