...
# 통화량 (101Y002: M1 협의통화 / 101Y003: M2 광의통화, 월별 평잔)
#   M2/M1 비율 = 유동성 회전속도. 낮으면 돈이 안 돌고(위험회피), 높으면 활발.
#   M2 증가율은 대표적 경기 선행지표.
S["M1"] = collect("M1협의통화", "101Y002", "M", [r"M1.*평잔", r"협의통화.*평잔", r"M1", r"협의통화"])
S["M2"] = collect("M2광의통화", "101Y003", "M", [r"M2.*평잔", r"광의통화.*평잔", r"M2", r"광의통화"])
